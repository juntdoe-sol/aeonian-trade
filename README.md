...
[![DEX: Phoenix Perps](https://img.shields.io/badge/DEX-Phoenix%20Perps-orange.svg)](https://www.phoenix.trade)

**Aeonian** is a mobile-first crypto perpetual futures trading app built on [Phoenix Perps](https://www.phoenix.trade) (Solana). It transforms on-chain trading into a competitive social sport through real-money 1v1 Battles, Royal Rumbles, monthly Prize Pots, and a Points Rewards system — all settled on-chain in USDC.
...
### Trade
- Perpetual futures on Phoenix Perps (Solana) — long/short with up to 15x leverage
...
| On-chain | Phoenix Perps, USDC (SPL), Jupiter aggregator |
...
Mobile App (React/Vite PWA → Android APK)
        │
        ├── Phoenix Perps SDK  ──► Solana mainnet (on-chain trades, positions)
...
- **Built on**: [Phoenix Perps](https://www.phoenix.trade) × [Solana](https://solana.com)
